    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <img src="image\wauu logo 3.jpg"  style="width:50px; height:50px;" alt="">
        <a class="navbar-brand" href="<?php echo ROOT_URL; ?>">WEST AFRICAN UNION UNIVERSITY INVENTORY SYSTEM</a>
