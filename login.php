...
$action = '';
	if(isset($_GET['action'])){
		...
		if($action == 'register'){
?>
			<img src="image\wauu logo 3.jpg" alt="" style="display:inline;
															float: left;
															width: 500px;">
			<div class="container">
			  <div class="row justify-content-center">
			  <div
			  style="margin-left: 10px;" class="col-sm-12 col-md-5 col-lg-8">
				<div class="card">
...
?>
<!-- Default Page Content (Reset password) -->
<img src="image\wauu logo 3.jpg" alt="" style="display:inline;
															float: left;
															width: 500px;">
			<div class="container">
			  <div class="row justify-content-center">
			  <div style="margin-top: 55px;" class="col-sm-12 col-md-5 col-lg-8">
				<div class="card">
				  <div class="card-header">
					Reset Password
				  </div>
...
?>
    ...
    <div class="container">
      <div class="row justify-content-center">
	  <div style="margin-top:90px" class="col-sm-12 col-md-5 col-lg-8">
		<div class="card">
		  <div class="card-header">
			Login
		  </div>
